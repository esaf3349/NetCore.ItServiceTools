...
{
    public class PlatformsGetByIdQueryHandler : IRequestHandler<PlatformsGetByIdQuery, PlatformsGetByIdVm>
    {
        private readonly IUnitOfWork _uow;
        private readonly IMapper _mapper;

        public PlatformsGetByIdQueryHandler(IUnitOfWork uow, IMapper mapper)
        {
            _uow = uow;
            _mapper = mapper;
        }
