...
{
    public class PlatformsGetAllQueryHandler : IRequestHandler<PlatformsGetAllQuery, PlatformsGetAllVm>
    {
        private readonly IUnitOfWork _uow;
        private readonly IMapper _mapper;

        public PlatformsGetAllQueryHandler(IUnitOfWork uow, IMapper mapper)
        {
            _uow = uow;
            _mapper = mapper;
        }
