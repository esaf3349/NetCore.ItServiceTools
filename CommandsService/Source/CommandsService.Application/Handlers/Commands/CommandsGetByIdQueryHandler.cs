...
{
    public class CommandsGetByIdQueryHandler : IRequestHandler<CommandsGetByIdQuery, CommandsGetByIdVm>
    {
        private readonly IUnitOfWork _uow;
        private readonly IMapper _mapper;

        public CommandsGetByIdQueryHandler(IUnitOfWork uow, IMapper mapper)
        {
            _uow = uow;
            _mapper = mapper;
        }
